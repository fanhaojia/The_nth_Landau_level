...
if __name__ == "__main__":
    ...
    j2=2
    j3=1
    y1= 0.0208333333334*x**(2*j1)*np.exp(-x**2/2)*hlcjh(0,j1+1,x**2/2)**2
    y2= 0.375*x**(2*j2)*np.exp(-x**2/2)*hlcjh(-1,j2+1,x**2/2)**2
    y3= 1.5*x**(2*j3)*np.exp(-x**2/2)*hlcjh(-2,j3+1,x**2/2)**2
    y=y1+y2+y3
    while i>=0:
        a=0 #积分上限
        b=50.0 #积分下限
